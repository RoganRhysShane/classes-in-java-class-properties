...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        planet2.distanceFromSun = 5000.;
        planet2.satellites = 420;
        ...
        System.out.println("Name: " + planet1.name + ", Distance from Sun: " + planet1.distanceFromSun
            + ", Satellites: " + planet1.satellites + " moon(s), Supports Life: " + planet1.supportsLife);
        ...
        System.out.println("Name: " + planet2.name + ", Distance from Sun: " + planet2.distanceFromSun
                + ", Satellites: " + planet2.satellites + " moon(s), Supports Life: " + planet2.supportsLife);
        /*
